...
class BIDSDataGrabberOutputSpec(TraitedSpec):
    ...
    ### SM ADJUSTED (add the following two specs)
    MPRAGE = OutputMultiPath(desc='output MP2RAGE images')  # here
    t1map = OutputMultiPath(desc='output MP2RAGE t1map images')  # and here
